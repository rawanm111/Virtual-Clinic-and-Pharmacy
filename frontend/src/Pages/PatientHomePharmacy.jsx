    ...
    <div className="row no-gutters" style={{ background: '#2f89fc' }}>
        ...
        <div className="media block-6 d-block text-center">
          ...
          <div className="media-body p-2 mt-3">
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
              Our pharmacists at MetaCare graduated from top-tier Med-Schools around the Globe.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-3 p-4 " style={{
        ...
        <div className="media block-6 d-block text-center" >
          ...
          <div className="media-body p-2 mt-3">
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
              You can contact emergency care through our website at any time of the day.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-3 d-flex p-4 " style={{ background: '#2f89fc' }}>
        <div className="media block-6 d-block text-center">
          ...
          <div className="media-body p-2 mt-3">
            <h3 className="heading" style={{ fontWeight: '500', fontSize: '22px', color: '#fff' }}>Various Medications</h3>
            <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
            You can find a wide variety of medications and products you need in out store.
            </p>
          </div>
        </div>
      </div>
