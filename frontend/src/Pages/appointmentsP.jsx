...
//   // const renderCellFunction = (params) => {
...
//   //   console.log(sessionPriceAfterDiscount, "sessionPriceAfterDiscount");
//   // };
...
//   const [allHealthPackages, setAllHealthPackages] = useState([]);
//   //get health package using axios
//   useEffect(() => {
//     axios
//       .get(`http://localhost:3000/health-packages`)
//       .then((response) => {
...
//     // console.log(appointment.DoctorName, "appointment");
//     console.log(docs, "doctorassss")
//     docs.forEach((doc) => {
//       if (doc.fullName === appointment.DoctorName) {
//         console.log(doc.hourlyRate, "hourly_rate");
//         setRate(doc.hourlyRate)
//       } 
//     });
//     const sessionPrice = rate;
//     patientHealthPackage.forEach((pack) => {
//       setPackName(pack.package);
//       return;
//     });
//     console.log(patientHealthPackage, "pack");
//     console.log(packName, "sessionPrice");

//     // console.log(appointment, "sessionPrice");
//     const healthPackage = patientHealthPackage.find((pkg) => pkg.package === appointment.healthPackage);
...
//     // If no health package, return the original session price
//     return sessionPrice;
//   };
...
//   ]
  ...
  //   }
  // };
  // // If appointmentsP.jsx is a class component
