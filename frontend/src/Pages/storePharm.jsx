                ...
                <div className="pricing-entry pb-5 text-center" style={{ borderRadius: '8px', height: '100%' }}>
                  ...
                  <a style={{ display: 'block', height: '200px', overflow: 'hidden', position: 'relative' }}>
                    ...
                    <IconButton
                      ...
                      onClick={() => handleEditClick(medication, 'picture', medication.picture)}
                    >
                      <EditIcon />
                    </IconButton>
                  </a>
                  ...
                  <h3 className="text-dark" style={{ height: '50px' }}>
                    ...
                    <p>
                      ...
                      <IconButton onClick={() => handleEditClick(medication, 'description', medication.description)}>
  <EditIcon />
</IconButton>
                  ...
                  <IconButton onClick={() => handleEditClick(medication, 'price', medication.price)}>
  <EditIcon />
</IconButton>
